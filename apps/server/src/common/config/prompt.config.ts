...
export const buildRealtimeSystemPrompt = ({
  ...
  return [
    ...
    "",
    "CONVERSATION STYLE:",
    `- Speak naturally in ${targetLabel}, like a premium live speaking coach chatting with the learner.`,
    "- Ask ONE question at a time, then wait for the answer.",
    `- If the learner struggles, give one very short hint in ${nativeLabel}, then immediately switch back.`,
