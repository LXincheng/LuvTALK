...
export const REALTIME_INPUT_AUDIO_SAMPLE_RATE = 16_000;
export const REALTIME_OUTPUT_AUDIO_SAMPLE_RATE = 24_000;
...
export const REALTIME_ASSISTANT_INTERRUPT_MIN_CHARS = 4;
